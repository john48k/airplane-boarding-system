      ...
      <div className="container">
        ...
        <div id="passenger-form">
          <form onSubmit={handleUpdate}>
            ...
            <input type="text" id="update-passengerid" name="passengerid" required /><br /><br />

            <label htmlFor="update-passportnumber">Update Passport Number:</label>
            <input type="text" id="update-passportnumber" name="passportnumber" required /><br /><br />
            ...
            <input type="tel" id="update-phonenumber" name="phonenumber" required /><br /><br />

            <div className="action-buttons">
              <button type="button" className="return-button" onClick={() => (window.location.href = "passenger.html")}>Return</button>
              <button id="update-passenger-btn" type="submit" className="confirm-button">Confirm</button>
            </div>
          </form>
        </div>
      </div>
